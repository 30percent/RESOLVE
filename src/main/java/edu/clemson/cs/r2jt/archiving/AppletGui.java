...
public class AppletGui {
    ...
    public StringBuffer generateAppletCode() {
        ...
        sb.append("" + "\n");
        sb.append("public class " + appletName + " extends Applet implements ActionListener, KeyListener{"
                + "\n");
        ...
        sb.append("        facilityLabel = new Label(facilityLabelMsg);" + "\n");
        ...
        sb.append("        outputTextArea.setBounds(outputTextAreaRec);" + "\n");
