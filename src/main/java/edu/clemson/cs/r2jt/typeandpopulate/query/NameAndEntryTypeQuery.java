 ...
 */
public class NameAndEntryTypeQuery extends BaseMultimatchSymbolQuery<SymbolTableEntry> {

    public NameAndEntryTypeQuery(PosSymbol qualifier, String name,
            Class<? extends SymbolTableEntry> entryType, MathSymbolTable.ImportStrategy importStrategy,
            MathSymbolTable.FacilityStrategy facilityStrategy, boolean localPriority) {
    ...
    public NameAndEntryTypeQuery(PosSymbol qualifier, PosSymbol name,
            Class<? extends SymbolTableEntry> entryType, MathSymbolTable.ImportStrategy importStrategy,
            MathSymbolTable.FacilityStrategy facilityStrategy, boolean localPriority) {
        this(qualifier, name.getName(), entryType, importStrategy, facilityStrategy, localPriority);
    }

    public NameAndEntryTypeQuery(PosSymbol qualifier, String name, Class<? extends SymbolTableEntry> entryType) {
        this(qualifier, name, entryType, MathSymbolTable.ImportStrategy.IMPORT_NONE,
